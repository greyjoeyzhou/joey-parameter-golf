...
BATCH_DIR="$ROOT/runs/2026-04-26_Valid2hBatch"
STATUS_FILE="$BATCH_DIR/status.tsv"
METADATA_FILE="$BATCH_DIR/metadata.tsv"
SUMMARY_FILE="$ROOT/notes/local-valid-tokenizer-2h-results-2026-04-26.md"
...
register_case "2026-04-26_CaseOps_SkipGates_ParResid_QKGain45_HessClip015_Valid2h" "CaseOps" "SkipGates_ParResid_QKGain45_HessClip015_2h" "non_qat"
register_case "2026-04-26_SP8192_SkipGates_ParResid_Valid2h" "SP8192" "SkipGates_ParResid_2h" "non_qat"
register_case "2026-04-26_CaseOps_SkipGates_ParResid_QAT10_QKGain40_Valid2h" "CaseOps" "SkipGates_ParResid_QAT10_QKGain40_2h" "qat"
...
run_case "2026-04-26_CaseOps_SkipGates_ParResid_QKGain45_HessClip015_Valid2h" "scripts/train_gpt_decode_sidecar.py" "../local_tokenizer_data/caseops_v1" "SKIP_GATES_ENABLED=1" "PARALLEL_RESIDUAL_START=7" "QK_GAIN_INIT=4.5" "HESSIAN_CLIP_LAMBDA=0.15"
run_case "2026-04-26_SP8192_SkipGates_ParResid_Valid2h" "scripts/train_gpt_decode_sidecar.py" "./data" "SKIP_GATES_ENABLED=1" "PARALLEL_RESIDUAL_START=7" "QK_GAIN_INIT=4.0" "HESSIAN_CLIP_LAMBDA=0.0"
run_case "2026-04-26_CaseOps_SkipGates_ParResid_QAT10_QKGain40_Valid2h" "scripts/train_gpt_decode_qat.py" "../local_tokenizer_data/caseops_v1" "SKIP_GATES_ENABLED=1" "PARALLEL_RESIDUAL_START=7" "QK_GAIN_INIT=4.0" "HESSIAN_CLIP_LAMBDA=0.15" "QAT_ENABLED=1" "QAT_FRACTION=0.10" "QAT_RAMP_STEPS=500" "QAT_TARGET=all" "QAT_LAYER_START=0" "QAT_LAYER_END=10"

update_summary
echo "[$(date -Iseconds)] valid 2h batch complete"
