...
export RUN_ID=2026-04-29_CaseOps_QKGain50_WD090_ProxyControl_Modal8x
...
cd /workspace
torchrun --nproc_per_node=8 --nnodes=1 --standalone /workspace/train_gpt_decode_sidecar.py
